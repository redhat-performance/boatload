...
def main():
  ...
  parser = argparse.ArgumentParser(
      description="Label nodes for the boatload workload",
      prog="labeler.py", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
  ...
  parser.add_argument("--shared-prefix", type=str, default="boatloads", help="Shared label prefix")
  parser.add_argument("--unique-prefix", type=str, default="boatloadu", help="Unique label prefix")
